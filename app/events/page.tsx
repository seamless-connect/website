...
export const metadata: Metadata = {
  ...
  description:
    "A curated calendar of domain, DNS, Internet standards, cloud, and network-infrastructure events relevant to Seamless Connect.",
};
    ...
    <main>
      ...
      <section className={styles.hero}>
        ...
        <p>
          ...
          cloud, hosting, and network-operator communities connected to
